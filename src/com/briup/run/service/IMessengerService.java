...
public interface IMessengerService {
	...
	void updateMessage(Messagerecord message) throws MessengerServiceException;
	// 发件箱
	List<Messagerecord> listSendMessage(String senderName) throws MessengerServiceException;
	//获取已收已读的邮件
	List<Messagerecord> listRecieveMessageRe(String recieveName) throws MessengerServiceException;
	//获取已收未读的邮件
	List<Messagerecord> listRecieveMessageR(String recieveName) throws MessengerServiceException;
