...
<script type="text/javascript">
		...
		function addFriend(){
			document.forms.blackListForm.action="<%=basePath%>matchFriend";
		...
		function delBuddy(){
			...
			document.forms.blackListForm.action="<%=basePath%>deleteBlackBuddy.action";
			document.forms.blackListForm.submit();		
		}	
</script>
...
<div id="main">
  ...
  <ul>
    ...
    <li><a href="blackList" title="黑名单"><span><b>黑名单</b></span></a></li>
  </ul>
</div>
<br /><br />
				...
				<tr>
					<td colspan="2" width="100%">
						<table width="100%">
							...
							<tbody>								
							<c:forEach items="${blackfriends}" var="black">
								<tr>
								<th width="10%" align="center">
									<input type="checkbox" name="nickName" value="${black.nickname}" />
								</th>
								<td width="20%" align="center">
									${black.nickname}
								</td>
								<td width="20%" align="center">${black.gender}</td>
								<td width="20%" align="center" >${black.age}</td>
								<td width="20%" align="center">${black.provincecity}</td>
								<td width="10%" align="center">
									<img src="images/button_delete.gif" alt="移动到好友名单" onclick="window.location='moveToFriendList.do?blackName=${black.nickname}'" style="cursor:hand"/>
								</td>
							</tr>				
							</c:forEach>			
