...
<script src="js/common.js" type="text/javascript"></script>
		...
		<script type="text/javascript">
			function delMessage(){
				...
				document.forms.outboxForm.action="<%=basePath%>delSendMessage.action";
...
<div id="main">
  ...
  <ul>
    ...
    <li><a href="outbox" title="发件箱"><span><b>发件箱</b></span></a></li>
  </ul>
</div>
<br /><br />
				...
				<tr>
					...
					<td width="100%" colspan="2">
						<table width="100%">
							...
							<tbody>
							<c:forEach items="${listSendMessage}" var="list">
								<tr>
									<td width="10%">
										<input type="checkbox" name="id" value="${list.id}" />
									</td>
									<td width="20%">
										<a href="view.do?id=${list.id}">${list.title}</a>
									</td>
									<td width="20%">${list.receiver}</td>
									<td width="30%">
										<fmt:formatDate value="${list.senddate}" pattern="yy-MM-dd hh:mm:ss" />
									</td>
