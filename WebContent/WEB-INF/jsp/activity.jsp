...
<div id="main">
  ...
  <div id="header">
    ...
    <div id="mainnav">
      <ul>
      <li class="login"><a href="activity">首页</a></li>
      ...
      <span><table width="100%" border="0">
								<tr>
									<td align="right">
									上一次登录时间：<fmt:formatDate value="${member.latestdate}" pattern="yy/MM/dd hh:mm:ss" />
										
									</td>
									<td align="center">
										欢迎，&nbsp;
										<a href="isCreateSpace.action"><font color="red">
												${member.nickname}</font> </a>&nbsp;
									</td>
									<td align="left">
										当前您的积米：&nbsp;&nbsp;
										<font color="red">${member.point} </font>&nbsp;&nbsp;
										当前等级：
										<font color="red">${member.graderecord.gradename}</font>
									</td>
								</tr>
							</table> </span>    </div>
   </div>
...
到今天为止，盖茨和他的妻子Melinda Gates建立的基金已经将25多亿美元用于了全球的健康事业，将14亿多美元用于改善人们的学习条件，其中包括为盖茨图书馆购置计算机设备、为美国和加拿大的低收入社区的公共图书馆提供互联网培训和互联网访问服务             </p>
	 ...
	 <table width="300">
		...
		<tr>
			...
			<td align="left"><font color="green"><b>在线人数：${count}</b></font></td>
		</tr>
