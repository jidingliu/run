...
<div id="main">
  ...
  <div id="header">
   ...
   <div id="tabs1">
  <ul>
    <li><a href="sendInfo" title="写纸条"><span><b>准备发送信息给${receivename}</b></span></a></li>
  </ul>
  ...
  <div id="content" align="center"> 
     <div id="center"><br/><br/>
		<table width="600">
			...
			<tr>
				<td width="100%">
					<form name="sendInfoForm" action="zsend.do" method="post" onsubmit="return sendInfo();">
						<table width="100%">
						<tbody>
						<tr>
							<th width="30%" class="line1" scope="col">收信人：</th>
							<td>
								<input type="text" name="receiver" style="width: 250;height: 25" value="${receivename}"/>
							</td>
						</tr>
						<tr>
							<th>主题：</th>
						...
						<tr>
							<th colspan="2">
								...
								<a href="matchFriend"><input type="button"value="返回"></input></a>
							</th>
						</tr>
						</tfoot>
