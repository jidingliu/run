				...
				<td width="100%">
					<table width="100%" border="0" style="margin: 5px 0;"
		 			...
		 			<tr>
		  			...
		  			<form  action="modifySpace.action" method="post"	enctype="multipart/form-data">
					...
					<tr>
						...
						<TD width="50%" align="left">
							<INPUT class=INPUT1 type=text maxLength=14 name=opinion value= "${member.memberSpace.opinion}"
					...
					<TR>
						...
						<c:if test="${member.memberSpace.runtime=='清晨'}">
						<TD width="50%" align="left">
						...
						<c:if test="${member.memberSpace.runtime=='午后'}">
						<TD width="50%" align="left">
						...
						<c:if test="${member.memberSpace.runtime=='黄昏'}">
						<TD width="50%" align="left">
							<input name="runtime" class=radio1 type="radio" value="清晨" />清晨
							<input type="radio" name="runtime" class=radio1 value="午后" />午后
					...
					<TR>
						<TD width="50%" align="right">
							<FONT color=#ff9933>*</FONT> 喜欢独自跑还是结伴跑？						</TD>
								<c:if test="${member.memberSpace.runhabit=='结伴'}">
								<TD width="50%" align="left">
								...
								<c:if test="${member.memberSpace.runhabit=='独自'}">
								<TD width="50%" align="left">
									<input type="radio" name="runhabit" class=radio1 value="独自"checked="checked" />独自
									<input type="radio" name="runhabit" class=radio1 value="结伴"  />结伴
								</TD>
								</c:if>
					...
					<TR>
						...
						<TD align="left">
							<INPUT class=INPUT1 type=text maxLength=20 name=runstar	value="${member.memberSpace.runstar}" style="width:200;height:25" />						</TD>
					</TR>
					<TR>
						<TD width="50%" align="right">
							<FONT color=#ff9933>*</FONT> 正在使用的手机：						</TD>
						<TD width="50%" align="left">
							<INPUT class=INPUT1 type=text maxLength=14 name=cellphone value="${member.memberSpace.cellphone}" 
																style="width:200;height:25" />						</TD>
					</TR>
					<TR>
						<TD width="50%" align="right">
						...
						<TD width="50%" align="left">
							<INPUT class="INPUT1" type="text" maxLength="14" name="runplace" value="${member.memberSpace.runplace}" 
																
																style="width:200;height:25" />						</TD>
					</TR>
					<TR>
						<TD width="50%" align="right">&nbsp;&nbsp;如需更改图片请进行选择：</TD>
						<TD align="left">
